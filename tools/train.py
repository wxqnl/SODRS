...
from ppdet.engine.trainer_ssod import Trainer_DenseTeacher, Trainer_Semi_RTDETR, Trainer_SODRS
...
def run(FLAGS, cfg):
    ...
    if ssod_method is not None:
        ...
        elif ssod_method == 'SODRS':
            trainer = Trainer_SODRS(cfg, mode='train')
